...
function Library:LoadingWindow(Config)
	...
	local size     = Config.Size or UDim2.fromOffset(340, 150)
	...
	LW.StatusLabel = New("TextLabel", {
		...
		FontFace = GetStyleProperty("FontMedium"),
		TextSize = GetStyleProperty("TextSizeSm"),
		Position = UDim2.new(0.5, 0, 0, topOffset + 22),
		AnchorPoint = Vector2.new(0.5, 0),
	...
	TweenService:Create(LW.Root, TweenInfo.new(0.22, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), { GroupTransparency = 0 }):Play()
	TweenService:Create(EntranceScale, TweenInfo.new(0.28, Enum.EasingStyle.Back, Enum.EasingDirection.Out), { Scale = 1 }):Play()
	...
	function LW:SetProgress(Pct)
		...
		TweenService:Create(LW.ProgressFill, TweenInfo.new(0.2, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
			Size = UDim2.new(Pct, 0, 1, 0),
		}):Play()
	end
