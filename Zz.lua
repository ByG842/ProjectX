...
ElementsTable.Chip = (function()
	...
	function Element:New(Idx, Config)
		...
		local function updateChip(item, btn)
			...
			btn.SetBg(active and 0.15 or 0.92)
			btn.SetText(active and 0 or 0.4)
			btn.SetStroke(active and 0.15 or 0.85)
		end
		for _, item in ipairs(Config.Items) do
			...
			local _, SetBg     = Creator.SpringMotor(0.92, chip, "BackgroundTransparency")
			local _, SetText   = Creator.SpringMotor(0.4,  chip, "TextTransparency")
			local _, SetStroke = Creator.SpringMotor(0.85, stroke, "Transparency")
			chip.SetBg, chip.SetText, chip.SetStroke = SetBg, SetText, SetStroke
