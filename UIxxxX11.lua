...
Components.Notification = (function()
	...
	function Notification:New(Config)
		...
		NewNotification.RootStroke = New("UIStroke", { Transparency = 0.5, ApplyStrokeMode = Enum.ApplyStrokeMode.Border, Color = accentColor, Thickness = GetStyleProperty("BorderThickness") })
