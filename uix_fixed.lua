...
local Themes = {
	...
	Minecraft = {
		Name = "Minecraft",
		Accent              = Color3.fromRGB(100, 220, 100),       -- grass green
		AcrylicMain         = Color3.fromRGB(30, 22, 14),          -- dark wood/dirt
		AcrylicBorder       = Color3.fromRGB(80, 58, 36),          -- plank border
		AcrylicGradient     = ColorSequence.new(Color3.fromRGB(25, 18, 10), Color3.fromRGB(38, 28, 16)),
		AcrylicNoise        = 0.80,
		TitleBarLine        = Color3.fromRGB(60, 44, 26),
		Tab                 = Color3.fromRGB(148, 120, 72),         -- sand/wood tab
		Element             = Color3.fromRGB(52, 40, 24),          -- dirt block
		ElementBorder       = Color3.fromRGB(18, 13, 7),
		InElementBorder     = Color3.fromRGB(88, 68, 40),
		ElementTransparency = 0.10,                                 -- เกือบทึบ (ไม่ glassy)
		ToggleSlider        = Color3.fromRGB(80, 60, 36),
		ToggleToggled       = Color3.fromRGB(20, 15, 8),
		SliderRail          = Color3.fromRGB(70, 52, 30),
		DropdownFrame       = Color3.fromRGB(110, 85, 50),
		DropdownHolder      = Color3.fromRGB(38, 28, 16),
		DropdownBorder      = Color3.fromRGB(18, 13, 7),
		DropdownOption      = Color3.fromRGB(90, 68, 40),
		Keybind             = Color3.fromRGB(80, 60, 36),
		Input               = Color3.fromRGB(100, 78, 46),
		InputFocused        = Color3.fromRGB(22, 17, 9),
		InputIndicator      = Color3.fromRGB(120, 95, 56),
		InputIndicatorFocus = Color3.fromRGB(100, 220, 100),
		Dialog              = Color3.fromRGB(48, 36, 20),
		DialogHolder        = Color3.fromRGB(38, 28, 16),
		DialogHolderLine    = Color3.fromRGB(28, 21, 11),
		DialogButton        = Color3.fromRGB(58, 44, 24),
		DialogButtonBorder  = Color3.fromRGB(100, 77, 44),
		DialogBorder        = Color3.fromRGB(80, 60, 34),
		DialogInput         = Color3.fromRGB(52, 40, 22),
		DialogInputLine     = Color3.fromRGB(120, 95, 56),
		Text                = Color3.fromRGB(255, 255, 85),        -- Minecraft yellow text
		SubText             = Color3.fromRGB(190, 190, 190),       -- gray subtext
		Hover               = Color3.fromRGB(100, 78, 46),
		HoverChange         = 0.06,
...
local StyleThemes = {
	...
	Minecraft = {
		...
		FontRegular       = Font.new("rbxasset://fonts/families/RobotoMono.json", Enum.FontWeight.Regular),
		FontMedium        = Font.new("rbxasset://fonts/families/RobotoMono.json", Enum.FontWeight.Medium),
		FontBold          = Font.new("rbxasset://fonts/families/RobotoMono.json", Enum.FontWeight.Bold),
		FontSemiBold      = Font.new("rbxasset://fonts/families/RobotoMono.json", Enum.FontWeight.Medium),
		-- TextSize
		TextSizeLg        = 13,
		TextSizeMd        = 12,
		TextSizeSm        = 11,
