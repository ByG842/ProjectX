...
Components.Tab = (function()
	...
	function TabModule:New(Title, Icon, Parent)
		...
		Tab.Frame = New("TextButton", {
			...
			NewCorner("ElementCorner"),
			New("TextLabel", {
				Visible = false, -- 🧭 icon rail: label hidden, name still shows via Window.TabDisplay / tooltip
				AnchorPoint = Vector2.new(0, 0.5),
			...
			New("ImageLabel", {
				AnchorPoint = Vector2.new(0.5, 0.5), -- 🧭 icon rail: centered instead of left-aligned next to a label
...
Components.Window = (function()
	...
	return function(Config)
		...
		Window.TabWidth = Config.TabWidth or 56 -- 🧭 icon rail width (was 170 for the labeled list)
