...
Components.Window = (function()
	...
	return function(Config)
		...
		function Window:Dialog(Config)
			...
			-- วัดความกว้างจริงของ Title (แบบไม่ตัดคำ) ด้วย TextService เพื่อเอามา
			-- ใช้คำนวณความกว้างกล่องร่วมกับ Content แล้วค่อย wrap เมื่อยาวเกิน maxWidth
			local titleFont = GetStyleProperty("FontSemiBold")
			local titleTextSize = GetStyleProperty("TextSizeTitle")
