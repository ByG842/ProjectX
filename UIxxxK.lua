	...
	return function(Config)
		...
		function Window:AddTabGroup(Label)
			local GroupDivider = New("Frame", {
				...
				BackgroundTransparency = 1,
				LayoutOrder = (TabModule.TabCount * 10) + 5, -- ✅ FIX: แทรกกลางระหว่างแท็บก่อนหน้ากับแท็บถัดไปตามลำดับที่เรียกจริง (เดิมไม่ตั้งค่าเลยเลยลอยไปอยู่บนสุดตามชื่อ Instance)
