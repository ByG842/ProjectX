...
local InterfaceManager = {} do
	...
	function InterfaceManager:BuildInterfaceSection(tab)
		...
		-- Minimize Bind sits at the very bottom of the Interface subtab, outside any section
		local MenuKeybind = InterfaceSubTab:AddKeybind("MenuKeybind", { Title = "Minimize Bind", Default = Library.MinimizeKey.Name or Settings.MenuKeybind })
		...
		-- Build the Config (save/load) subtab if SaveManager is already wired up.
		-- If not, the caller can still run SaveManager:BuildConfigSection(InterfaceManager.ConfigSubTab) manually.
		if SaveManager and SaveManager.Library and SaveManager.BuildConfigSection then
