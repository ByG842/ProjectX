...
local Themes = {
	...
	Dark = {
		Name = "Dark",
		-- 🔵 Indigo accent แทนสีเทาล้วนของเดิม ให้ดูพรีเมียม/modern SaaS มากขึ้น
		Accent = Color3.fromRGB(99, 102, 241),
		AcrylicMain = Color3.fromRGB(14, 15, 19),
		AcrylicBorder = Color3.fromRGB(36, 38, 46),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(11, 12, 16), Color3.fromRGB(17, 18, 23)),
		AcrylicNoise = 0.93,
		TitleBarLine = Color3.fromRGB(32, 34, 42),
		Tab = Color3.fromRGB(118, 120, 132),
		Element = Color3.fromRGB(26, 27, 33),
		ElementBorder = Color3.fromRGB(10, 11, 14),
		InElementBorder = Color3.fromRGB(42, 44, 52),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromRGB(72, 74, 84),
		-- ⚪ Knob สีขาวนวลตัดกับ track สี Accent ตอนเปิด (สไตล์ iOS/Material)
		ToggleToggled = Color3.fromRGB(245, 245, 250),
		SliderRail = Color3.fromRGB(58, 60, 70),
		DropdownFrame = Color3.fromRGB(110, 112, 124),
		DropdownHolder = Color3.fromRGB(24, 25, 31),
		DropdownBorder = Color3.fromRGB(10, 11, 14),
		DropdownOption = Color3.fromRGB(68, 70, 80),
		Keybind = Color3.fromRGB(72, 74, 84),
		Input = Color3.fromRGB(110, 112, 124),
		InputFocused = Color3.fromRGB(9, 10, 13),
		InputIndicator = Color3.fromRGB(90, 92, 104),
		InputIndicatorFocus = Color3.fromRGB(99, 102, 241),
		Dialog = Color3.fromRGB(26, 27, 33),
		DialogHolder = Color3.fromRGB(19, 20, 25),
		DialogHolderLine = Color3.fromRGB(14, 15, 19),
		DialogButton = Color3.fromRGB(30, 31, 38),
		DialogButtonBorder = Color3.fromRGB(54, 56, 66),
		DialogBorder = Color3.fromRGB(44, 46, 54),
		DialogInput = Color3.fromRGB(34, 35, 42),
		DialogInputLine = Color3.fromRGB(110, 112, 124),
		Text = Color3.fromRGB(236, 237, 241),
		SubText = Color3.fromRGB(146, 148, 160),
		Hover = Color3.fromRGB(50, 52, 62),
		HoverChange = 0.08,
	},
	Darker = {
		Name = "Darker",
	...
	AMOLED = {
		...
		ToggleToggled = Color3.fromRGB(240, 240, 250),
...
local StyleThemes = {
	Default = {
		...
		SmallCorner       = UDim.new(0, 7),
		TinyCorner        = UDim.new(0, 5),
...
Components.Tab = (function()
	...
	function TabModule:New(Title, Icon, Parent)
		...
		local TabTextLabel = New("TextLabel", {
			AnchorPoint = Vector2.new(0, 0.5),
		...
		local TabIconImage = New("ImageLabel", {
			AnchorPoint = Vector2.new(0, 0.5),
			Size = UDim2.fromOffset(16, 16),
	...
	function TabModule:SelectTab(Tab)
		...
		for _, TabObject in next, TabModule.Tabs do
			...
			if TabObject.TextLabel then
				Creator.OverrideTag(TabObject.TextLabel, { TextColor3 = "Text" })
			end
			if TabObject.IconImage then
				Creator.OverrideTag(TabObject.IconImage, { ImageColor3 = "Text" })
			end
		end
		TabModule.Tabs[Tab].SetTransparency(0.89)
		TabModule.Tabs[Tab].Selected = true
		if TabModule.Tabs[Tab].TextLabel then
			Creator.OverrideTag(TabModule.Tabs[Tab].TextLabel, { TextColor3 = "Accent" })
		end
		if TabModule.Tabs[Tab].IconImage then
			Creator.OverrideTag(TabModule.Tabs[Tab].IconImage, { ImageColor3 = "Accent" })
		end
...
Components.Window = (function()
	...
	return function(Config)
		...
		local ResizeGripIcon = New("ImageLabel", {
			...
			ZIndex = 21,
			ThemeTag = { ImageColor3 = "SubText" }, -- ✅ FIX: เดิม hardcode สีขาว มองไม่เห็นในธีมสว่าง ตอนนี้ตามธีมแล้ว
		})
		...
		do
			local ENTRANCE_DURATION = 0.7 -- ⚡ ลดจาก 1.8s ให้เข้าไวขึ้น รู้สึก snappy กว่าเดิม แต่ยังนุ่มด้วย Quint easing
...
local MinimizeButton = New("TextButton", {
	...
	New("UIStroke", { ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
		...
		ThemeTag = { Color = "Accent" } }), -- ✅ FIX: เดิม hardcode สีฟ้า ไม่ตามธีม ตอนนี้ผูกกับ Accent ของธีมแล้ว
