...
Components.Notification = (function()
	...
	function Notification:New(Config)
		...
		-- [ จุดที่แก้ ] แท่งสีข้างซ้าย เดิมทึบแบนๆ ยาวเท่ากันตลอด — ใส่ gradient จางที่ปลายบน-ล่าง
		-- ให้ดูเป็นแสง glow มีมิติ ไม่ใช่แท่งสีทึบตรงๆ นุ่มนวลขึ้น เข้ากับโทนการ์ดที่ปรับให้หรูขึ้น
		...
		-- [ จุดที่เพิ่ม ] glow เบลอๆ จางๆ อยู่หลัง badge ให้ไอคอนดูมีมิติ ไม่ใช่วงกลมแบนแปะบนพื้นเฉยๆ
		...
		-- [ จุดที่แก้ ] เพิ่มความหนาเล็กน้อย (2->3) และใส่ gradient สว่าง-เข้มให้เส้น fill ดูมีมิติ
		-- ไม่ใช่แท่งสีเรียบแบนๆ
		...
		-- [ จุดที่เพิ่ม ] ไล่สี wash จางๆ ของ accent เข้าไปในพื้นหลัง (มุมบนซ้ายเข้มกว่านิดหน่อย ไล่จางลง
		-- ทางขวาล่าง) ให้การ์ดแต่ละ type มีเอกลักษณ์สีของตัวเองแทนที่จะเป็นสีเทาเอกรงค์เหมือนกันหมดทุกอัน
		-- (มี TypeBar/ไอคอนบอกสีอยู่แล้ว แต่ wash เบาๆ นี้ทำให้ทั้งใบรู้สึกเข้าธีมสีเดียวกันมากขึ้น)
		local AccentWash = New("Frame", {
			Size = UDim2.new(1, 0, 1, 0),
			BackgroundColor3 = accentColor,
			BackgroundTransparency = 1, -- ควบคุมผ่าน UIGradient.Transparency ทั้งหมด ตัวพื้น Frame โปร่งเต็ม
			BorderSizePixel = 0,
		}, {
			NewCorner("WindowCorner"),
			New("UIGradient", {
		...
		-- [ จุดที่แก้ ] เส้นขอบเดิมทึบเท่ากันรอบด้าน — ใส่ gradient จางที่ขอบล่างให้ดูเหมือนแสงตกกระทบ
		-- จากด้านบน (glass edge highlight) มีมิติมากกว่าเส้นขอบสีเดียวแบนๆ
