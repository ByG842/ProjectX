...
Components.Section = (function()
    ...
    return function(Title, Parent, Icon, Description) -- เพิ่ม Parameter: Description
        local Section = {}

        -- padding รอบ elements ข้างใน card
        local CARD_PAD_H  = 8   -- padding ซ้ายขวาภายใน card
        local CARD_PAD_V  = 6   -- padding บนล่างภายใน card
        local HEADER_H    = Description and 42 or 28  -- ปรับความสูง header อัตโนมัติถ้ามี Description
        local GAP_TOP     = 6   -- ระยะห่างระหว่าง section card กับของข้างบน
        local BOTTOM_PAD  = 12  -- ระยะห่างด้านล่างสุดให้คอนเทนต์ไม่ชิดขอบกรอบเกินไป
        ...
        -- TextContainer สำหรับมัดรวม Title กับ Description ให้เรียงกันสวยๆ
        local TextContainer = New("Frame", {
            ...
            New("UIListLayout", {
                SortOrder = Enum.SortOrder.LayoutOrder,
                VerticalAlignment = Enum.VerticalAlignment.Center,
                Padding = UDim.new(0, 2), -- ระยะห่างระหว่าง Title กับ Description
            }),
            New("TextLabel", {
                RichText = true,
                Text = Title,
                ...
                TextSize = 15, -- ขยายขนาด Title ให้ใหญ่ขึ้น
                TextXAlignment = "Left",
            ...
            -- ถ้ามีการส่ง Description มาถึงจะสร้าง TextLabel ตัวนี้
            Description and New("TextLabel", {
                Text = Description,
        ...
        local SectionHeader = New("Frame", {
            ...
            TextContainer, -- วาง TextContainer ลงไปแทน TextLabel ปกติ
        })
        ...
        Creator.AddSignal(Section.Layout:GetPropertyChangedSignal("AbsoluteContentSize"), function()
            ...
            -- คำนวณความสูงโดยบวก BOTTOM_PAD เพิ่มเข้าไป
            local totalCardH = HEADER_H + CARD_PAD_V + contentH + BOTTOM_PAD
...
Components.Tab = (function()
	...
	function TabModule:New(Title, Icon, Parent)
		...
		-- 📌 1. เพิ่ม SectionDescription เข้าไปในพารามิเตอร์รับค่า
		function Tab:AddSection(SectionTitle, SectionIcon, SectionDescription)
			if self.SelectedSubTab > 0 and self.SubTabs[self.SelectedSubTab] then
				-- ส่ง SectionDescription ต่อไปให้ SubTab ด้วย
			...
			-- 📌 2. ส่ง SectionDescription ต่อไปให้ Components.Section เป็นตัวแปรที่ 4
