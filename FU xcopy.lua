	...
	function TabModule:SelectTab(Tab)
		...
		for _, TabObject in next, TabModule.Tabs do
			...
			if TabObject.Frame then
				TabObject.Frame.BackgroundColor3 = Color3.fromRGB(50, 50, 60)
			end
		end
		TabModule.Tabs[Tab].SetTransparency(0.89)
		TabModule.Tabs[Tab].Selected = true
		if TabModule.Tabs[Tab].Frame then
			TabModule.Tabs[Tab].Frame.BackgroundColor3 = Color3.fromRGB(65, 140, 220)
		end
...
Components.TitleBar = (function()
	...
	return function(Config)
		...
		-- MINIMALIST MACOS TITLEBAR FRAME — 28px height
		TitleBar.Frame = New("Frame", {
			...
			-- macOS Control Buttons (Red/Yellow/Green) on left side
			New("Frame", {
				Name = "ControlButtons",
		...
		-- macOS-style control buttons (colored circles)
		local function MacOSButton(color, position, callback)
			...
			local Motor, SetTransparency = Creator.SpringMotor(0, button, "BackgroundTransparency")
			AddSignal(button.MouseEnter, function() SetTransparency(0.3) end)
			AddSignal(button.MouseLeave, function() SetTransparency(0, true) end)
			AddSignal(button.MouseButton1Click, callback)

			return button
		end

		local controlButtonsFrame = TitleBar.Frame:FindFirstChild("ControlButtons")

		-- Close button (Red)
		TitleBar.CloseButton = MacOSButton(
		...
		TitleBar.CloseButton.Parent = controlButtonsFrame

		-- Minimize button (Yellow)
		TitleBar.MinButton = MacOSButton(
		...
		TitleBar.MinButton.Parent = controlButtonsFrame

		-- Maximize button (Green)
		TitleBar.MaxButton = MacOSButton(
		...
		TitleBar.MaxButton.Parent = controlButtonsFrame
...
Components.Window = (function()
	...
	return function(Config)
		...
		local imageSize = Window.TabWidth - 24
		local topOffset = Window.TopOffset or 5
		...
		local TabFrame = New("Frame", {
			Size = UDim2.new(0, Window.TabWidth, 1, Window.ShowSearch and -(titleBarHeight + 63) or -(titleBarHeight + 31)),
			Position = UDim2.new(0, 12, 0, Window.ShowSearch and (titleBarHeight + 28) or titleBarHeight),
			BackgroundTransparency = 1,
			ClipsDescendants = true,
		}, {
			ImageFrame,
		...
		Window.ContainerCanvas = New("Frame", {
			Size = UDim2.new(1, -Window.TabWidth - 32, 1, -62),
			Position = UDim2.fromOffset(Window.TabWidth + 26, 56),
			BackgroundTransparency = 1,
			ClipsDescendants = true,
		}, {
		...
		-- Create drop shadow frame for macOS-style effect
		local shadowFrame = Instance.new("Frame")
		shadowFrame.Name = "DropShadow"
		shadowFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
		shadowFrame.BackgroundTransparency = 0.92
		shadowFrame.BorderSizePixel = 0
		shadowFrame.Size = Window.Size + UDim2.new(0, 4, 0, 4)
		shadowFrame.Position = Window.Position + UDim2.new(0, 2, 0, 2)
		...
		-- Add rounded corners to main window
		local rootCorner = Instance.new("UICorner")
		rootCorner.CornerRadius = UDim.new(0, 12)
		rootCorner.Parent = Window.Root

		-- Parent shadow frame after Root is created
		shadowFrame.Parent = Config.Parent

		-- Update shadow position when window moves
		local updateShadow = function()
			shadowFrame.Size = Window.Root.Size + UDim2.new(0, 4, 0, 4)
			shadowFrame.Position = Window.Root.Position + UDim2.new(0, 2, 0, 2)
			shadowFrame.ZIndex = Window.Root.ZIndex - 1
		end
		Creator.AddSignal(Window.Root:GetPropertyChangedSignal("Position"), updateShadow)
		Creator.AddSignal(Window.Root:GetPropertyChangedSignal("Size"), updateShadow)
