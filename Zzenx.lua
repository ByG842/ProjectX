...
local Themes = {
	...
	-- ✨ Minimal Flat — เรียบ สะอาด ไม่มีเงา/ไล่เฉด คอนทราสต์ต่ำ เส้นบางๆ
	Minimal = {
		Name                = "Minimal",
		Accent              = Color3.fromRGB(60, 60, 65),
		AcrylicMain         = Color3.fromRGB(24, 24, 26),
		AcrylicBorder       = Color3.fromRGB(24, 24, 26),          -- เท่ากับพื้น = ไร้ขอบ/ไร้เงา
		AcrylicGradient     = ColorSequence.new(Color3.fromRGB(24, 24, 26), Color3.fromRGB(24, 24, 26)), -- flat สนิท ไม่ไล่เฉด
		AcrylicNoise        = 1,                                    -- ปิดพื้นผิวนอยส์
		TitleBarLine        = Color3.fromRGB(24, 24, 26),
		Tab                 = Color3.fromRGB(120, 120, 125),
		Element             = Color3.fromRGB(32, 32, 35),
		ElementBorder       = Color3.fromRGB(32, 32, 35),           -- ไม่มีเส้นขอบ (สีเดียวกับตัว element)
		InElementBorder     = Color3.fromRGB(42, 42, 46),
		ElementTransparency = 1,                                    -- flat เต็ม ไม่มีชั้นความโปร่งซ้อน
		ToggleSlider        = Color3.fromRGB(70, 70, 76),
		ToggleToggled       = Color3.fromRGB(24, 24, 26),
		SliderRail          = Color3.fromRGB(44, 44, 48),
		DropdownFrame       = Color3.fromRGB(32, 32, 35),
		DropdownHolder      = Color3.fromRGB(28, 28, 30),
		DropdownBorder      = Color3.fromRGB(28, 28, 30),
		DropdownOption      = Color3.fromRGB(38, 38, 42),
		Keybind             = Color3.fromRGB(38, 38, 42),
		Input               = Color3.fromRGB(32, 32, 35),
		InputFocused        = Color3.fromRGB(28, 28, 30),
		InputIndicator      = Color3.fromRGB(70, 70, 76),
		InputIndicatorFocus = Color3.fromRGB(230, 230, 235),
		Dialog              = Color3.fromRGB(28, 28, 30),
		DialogHolder        = Color3.fromRGB(24, 24, 26),
		DialogHolderLine    = Color3.fromRGB(24, 24, 26),
		DialogButton        = Color3.fromRGB(32, 32, 35),
		DialogButtonBorder  = Color3.fromRGB(32, 32, 35),
		DialogBorder        = Color3.fromRGB(28, 28, 30),
		DialogInput         = Color3.fromRGB(32, 32, 35),
		DialogInputLine     = Color3.fromRGB(70, 70, 76),
		Text                = Color3.fromRGB(235, 235, 238),
		SubText             = Color3.fromRGB(140, 140, 145),
		Hover               = Color3.fromRGB(42, 42, 46),
