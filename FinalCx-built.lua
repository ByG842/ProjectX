...
-- Centralized "which window is active" lookup.
-- Replaces the repeated `Library.Window ... elseif Library.Windows and #Library.Windows > 0 ...`
-- pattern that was duplicated across Element/Section/Dropdown/etc.
-- Priority: the explicitly-set single-window slot (Library.Window), otherwise the
-- most recently created window in the Library.Windows list.
...
-- Like GetActiveWindow, but for call sites that need a *specific property*
-- (e.g. .Root, .DropdownsOutsideWindow) which might only be set on an earlier
-- window rather than the most recent one. Scans Library.Windows newest -> oldest
-- and returns the first window where the property isn't nil.
function Library:FindWindowWithProperty(PropertyName)
	if Library.Window and Library.Window[PropertyName] ~= nil then
		return Library.Window, Library.Window[PropertyName]
	end
	if Library.Windows then
		for i = #Library.Windows, 1, -1 do
			local window = Library.Windows[i]
			if window and window[PropertyName] ~= nil then
				return window, window[PropertyName]
			end
		end
	end
	return nil, nil
...
Components.Element = (function()
	...
	return function(Title, Desc, Parent, Hover, Options)
		...
		function Element:SetTitle(Set)
			...
			local activeWindow = Library:GetActiveWindow()
			if activeWindow and activeWindow.AllElements and activeWindow.AllElements[Element.Frame] then
				activeWindow.AllElements[Element.Frame].title = Set
			end
		end
		...
		function Element:SetDesc(Set)
			...
			local activeWindow = Library:GetActiveWindow()
			if activeWindow and activeWindow.AllElements and activeWindow.AllElements[Element.Frame] then
				activeWindow.AllElements[Element.Frame].description = Set
			end
		end
		...
		local activeWindow = Library:GetActiveWindow()
		if activeWindow and activeWindow.RegisterElement then
			activeWindow.RegisterElement(Element.Frame, Title, "Element", Desc)
		end
...
Components.Section = (function()
	...
	return function(Title, Parent, Icon)
		...
		local activeWindow = Library:GetActiveWindow()
		if activeWindow and activeWindow.RegisterElement then
			activeWindow.RegisterElement(Section.Root, Title, "Section")
		end
...
Components.Window = (function()
	...
	return function(Config)
		...
		-- ============================================================
		-- SECTION: Positioning  (future file: Components/Window/Positioning.lua)
		-- ============================================================
		...
		-- ============================================================
		-- SECTION: Search / Element Filtering  (future file: Components/Window/Search.lua)
		-- ============================================================
		...
		-- ============================================================
		-- SECTION: Element Registry  (future file: Components/Window/ElementRegistry.lua)
		-- Feeds both Search (above) and AllElements lookups used by
		-- Library:GetActiveWindow()/FindWindowWithProperty() call sites.
		-- ============================================================
		...
		-- ============================================================
		-- SECTION: Sidebar Collapse  (future file: Components/Window/Sidebar.lua)
		-- ============================================================
		...
		-- ============================================================
		-- SECTION: Minimize/Maximize Animation Setup  (future file: Components/Window/MinimizeAnimation.lua)
		-- ============================================================
		...
		-- ============================================================
		-- SECTION: Drag & Resize  (future file: Components/Window/DragResize.lua)
		-- UpdateContainerPosition + TitleBar drag + ResizeStartFrame drag +
		-- the shared UserInputService.InputChanged handler below all
		-- cooperate on moving/resizing the window, so they move together.
		-- ============================================================
		...
		-- ============================================================
		-- SECTION: Tab Holder Layout  (future file: Components/Window/TabLayout.lua)
		-- ============================================================
		...
		-- ============================================================
		-- SECTION: Keybinds  (future file: Components/Window/Keybinds.lua)
		-- ============================================================
		...
		-- Public API for SECTION: Search / Element Filtering (see UpdateElementVisibility above)
		...
		-- ============================================================
		-- SECTION: Minimize/Maximize + Lifecycle  (future file: Components/Window/Lifecycle.lua)
		-- ============================================================
		...
		-- ============================================================
		-- SECTION: Background Customization  (future file: Components/Window/Background.lua)
		-- ============================================================
		...
		-- ============================================================
		-- SECTION: Dialog  (future file: Components/Window/Dialog.lua — thin wrapper,
		-- most of the Dialog implementation already lives in Components.Dialog)
		-- ============================================================
		...
		-- ============================================================
		-- SECTION: Tab Management  (future file: Components/Window/Tabs.lua)
		-- ============================================================
...
ElementsTable.Dropdown = (function()
	...
	function Element:New(Idx, Config)
		...
		local _, windowDropdownsOutside = Library:FindWindowWithProperty("DropdownsOutsideWindow")
		windowDropdownsOutside = windowDropdownsOutside or false
		...
		local _, windowRoot = Library:FindWindowWithProperty("Root")
		...
		local function RecalculateListPosition()
			...
			if not windowRoot then
				local _, foundRoot = Library:FindWindowWithProperty("Root")
				windowRoot = foundRoot
