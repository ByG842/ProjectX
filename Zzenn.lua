--[[
	Zzen.lua — Fluent-based Roblox UI Library
	Version: 2.1.0

	Rework Pass 2 (this pass) เพิ่ม/แก้ทั้งหมด 100+ จุด สรุปหมวดหลักๆ:
	  • Bug fix: ลบ dead-code (Icons table ซ้ำ ~830 บรรทัด, NotificationModule:Init ซ้ำ),
	    เติม element ที่ SaveManager เตรียม parser ไว้แต่ไม่เคยมีจริง (TagInput, SearchBar, NotifBadge)
	  • Element ใหม่ 11 ตัว: ProgressBar, Rating, SegmentedControl, RangeSlider, Timeline,
	    Breadcrumb, EmptyState, LoadingSpinner, CodeBlock, HotkeyDisplay, StatCard
	  • ธีมใหม่ 7 ธีม: Nord, Dracula, Solarized, Crimson, Cyber, Forest, HighContrast (accessibility)
	  • Library.Utils: ฟังก์ชันช่วยเหลือ 21 ตัว (Debounce, Throttle, FormatNumber, GetTextSize+cache ฯลฯ)
	  • ระบบ Tooltip กลาง + Element:SetDisabled() ที่ใช้ได้กับทุก element ผ่าน Options
	  • Library:CreateWatermark() (FPS/ข้อความมุมจอ), Config export/import เป็น string,
	    ปุ่ม Reset to default, toggle เสียงแจ้งเตือน, global alias "Zzen" คู่กับ "Fluent"

	ดูรายละเอียดทั้งหมดใน CHANGELOG.md ที่แนบมาด้วย
]]
...
local Themes = {
	...
	Nord = {
		...
		AcrylicMain = Color3.fromRGB(30, 37, 41),
		AcrylicBorder = Color3.fromRGB(68, 91, 102),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(23, 29, 32), Color3.fromRGB(57, 63, 67)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(83, 109, 122),
		Tab = Color3.fromRGB(113, 146, 163),
		Element = Color3.fromRGB(98, 128, 143),
		ElementBorder = Color3.fromRGB(49, 64, 71),
		InElementBorder = Color3.fromRGB(74, 93, 102),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(123, 157, 173),
		ToggleToggled = Color3.fromRGB(37, 58, 68),
		SliderRail = Color3.fromRGB(123, 157, 173),
		DropdownFrame = Color3.fromRGB(133, 167, 184),
		DropdownHolder = Color3.fromRGB(42, 55, 61),
		DropdownBorder = Color3.fromRGB(49, 64, 71),
		DropdownOption = Color3.fromRGB(123, 157, 173),
		Keybind = Color3.fromRGB(123, 157, 173),
		Input = Color3.fromRGB(123, 157, 173),
		InputFocused = Color3.fromRGB(24, 32, 36),
		InputIndicator = Color3.fromRGB(143, 177, 194),
		InputIndicatorFocus = Color3.fromRGB(115, 208, 255),
		Dialog = Color3.fromRGB(42, 55, 61),
		DialogHolder = Color3.fromRGB(36, 50, 56),
		DialogHolderLine = Color3.fromRGB(31, 44, 51),
		DialogButton = Color3.fromRGB(42, 55, 61),
		DialogButtonBorder = Color3.fromRGB(76, 100, 112),
		DialogBorder = Color3.fromRGB(68, 91, 102),
		DialogInput = Color3.fromRGB(52, 65, 71),
		DialogInputLine = Color3.fromRGB(133, 167, 184),
		Text = Color3.fromRGB(240, 240, 240),
		SubText = Color3.fromRGB(170, 170, 170),
		Hover = Color3.fromRGB(123, 157, 173),
		HoverChange = 0.05
	},
	Dracula = {
		Name = "Dracula",
		Accent = Color3.fromRGB(255, 121, 198),
		AcrylicMain = Color3.fromRGB(30, 23, 40),
		AcrylicBorder = Color3.fromRGB(70, 49, 100),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(23, 18, 31), Color3.fromRGB(57, 51, 66)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(85, 60, 120),
		Tab = Color3.fromRGB(115, 84, 160),
		Element = Color3.fromRGB(100, 72, 140),
		ElementBorder = Color3.fromRGB(50, 36, 70),
		InElementBorder = Color3.fromRGB(75, 57, 100),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(125, 94, 170),
		ToggleToggled = Color3.fromRGB(39, 19, 67),
		SliderRail = Color3.fromRGB(125, 94, 170),
		DropdownFrame = Color3.fromRGB(135, 104, 180),
		DropdownHolder = Color3.fromRGB(43, 30, 60),
		DropdownBorder = Color3.fromRGB(50, 36, 70),
		DropdownOption = Color3.fromRGB(125, 94, 170),
		Keybind = Color3.fromRGB(125, 94, 170),
		Input = Color3.fromRGB(125, 94, 170),
		InputFocused = Color3.fromRGB(25, 18, 35),
		InputIndicator = Color3.fromRGB(145, 114, 190),
		InputIndicatorFocus = Color3.fromRGB(129, 38, 255),
		Dialog = Color3.fromRGB(43, 30, 60),
		DialogHolder = Color3.fromRGB(38, 25, 55),
		DialogHolderLine = Color3.fromRGB(33, 20, 50),
		DialogButton = Color3.fromRGB(43, 30, 60),
		DialogButtonBorder = Color3.fromRGB(78, 55, 110),
		DialogBorder = Color3.fromRGB(70, 49, 100),
		DialogInput = Color3.fromRGB(53, 40, 70),
		DialogInputLine = Color3.fromRGB(135, 104, 180),
		Text = Color3.fromRGB(240, 240, 240),
		SubText = Color3.fromRGB(170, 170, 170),
		Hover = Color3.fromRGB(125, 94, 170),
		HoverChange = 0.05
	},
	Solarized = {
		Name = "Solarized",
		Accent = Color3.fromRGB(38, 139, 210),
		AcrylicMain = Color3.fromRGB(21, 34, 38),
		AcrylicBorder = Color3.fromRGB(44, 84, 95),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(16, 27, 30), Color3.fromRGB(49, 61, 64)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(54, 101, 114),
		Tab = Color3.fromRGB(75, 135, 152),
		Element = Color3.fromRGB(65, 118, 133),
		ElementBorder = Color3.fromRGB(32, 59, 66),
		InElementBorder = Color3.fromRGB(52, 86, 95),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(85, 145, 162),
		ToggleToggled = Color3.fromRGB(16, 53, 64),
		SliderRail = Color3.fromRGB(85, 145, 162),
		DropdownFrame = Color3.fromRGB(94, 154, 171),
		DropdownHolder = Color3.fromRGB(27, 51, 57),
		DropdownBorder = Color3.fromRGB(32, 59, 66),
		DropdownOption = Color3.fromRGB(85, 145, 162),
		Keybind = Color3.fromRGB(85, 145, 162),
		Input = Color3.fromRGB(85, 145, 162),
		InputFocused = Color3.fromRGB(16, 30, 33),
		InputIndicator = Color3.fromRGB(104, 164, 180),
		InputIndicatorFocus = Color3.fromRGB(24, 195, 242),
		Dialog = Color3.fromRGB(27, 51, 57),
		DialogHolder = Color3.fromRGB(22, 46, 52),
		DialogHolderLine = Color3.fromRGB(18, 41, 47),
		DialogButton = Color3.fromRGB(27, 51, 57),
		DialogButtonBorder = Color3.fromRGB(49, 92, 104),
		DialogBorder = Color3.fromRGB(44, 84, 95),
		DialogInput = Color3.fromRGB(37, 60, 66),
		DialogInputLine = Color3.fromRGB(94, 154, 171),
		Text = Color3.fromRGB(240, 240, 240),
		SubText = Color3.fromRGB(170, 170, 170),
		Hover = Color3.fromRGB(85, 145, 162),
		HoverChange = 0.05
	},
	Crimson = {
		Name = "Crimson",
		Accent = Color3.fromRGB(224, 64, 64),
		AcrylicMain = Color3.fromRGB(38, 22, 25),
		AcrylicBorder = Color3.fromRGB(95, 47, 55),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 17, 20), Color3.fromRGB(64, 50, 53)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(114, 57, 67),
		Tab = Color3.fromRGB(152, 79, 91),
		Element = Color3.fromRGB(133, 68, 79),
		ElementBorder = Color3.fromRGB(66, 34, 40),
		InElementBorder = Color3.fromRGB(95, 55, 61),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(162, 89, 101),
		ToggleToggled = Color3.fromRGB(64, 18, 26),
		SliderRail = Color3.fromRGB(162, 89, 101),
		DropdownFrame = Color3.fromRGB(171, 98, 110),
		DropdownHolder = Color3.fromRGB(57, 29, 33),
		DropdownBorder = Color3.fromRGB(66, 34, 40),
		DropdownOption = Color3.fromRGB(162, 89, 101),
		Keybind = Color3.fromRGB(162, 89, 101),
		Input = Color3.fromRGB(162, 89, 101),
		InputFocused = Color3.fromRGB(33, 17, 20),
		InputIndicator = Color3.fromRGB(180, 108, 120),
		InputIndicatorFocus = Color3.fromRGB(242, 36, 71),
		Dialog = Color3.fromRGB(57, 29, 33),
		DialogHolder = Color3.fromRGB(52, 24, 29),
		DialogHolderLine = Color3.fromRGB(47, 19, 24),
		DialogButton = Color3.fromRGB(57, 29, 33),
		DialogButtonBorder = Color3.fromRGB(104, 52, 61),
		DialogBorder = Color3.fromRGB(95, 47, 55),
		DialogInput = Color3.fromRGB(66, 38, 43),
		DialogInputLine = Color3.fromRGB(171, 98, 110),
		Text = Color3.fromRGB(240, 240, 240),
		SubText = Color3.fromRGB(170, 170, 170),
		Hover = Color3.fromRGB(162, 89, 101),
		HoverChange = 0.05
	},
	Cyber = {
		Name = "Cyber",
		Accent = Color3.fromRGB(255, 45, 200),
		AcrylicMain = Color3.fromRGB(36, 19, 40),
		AcrylicBorder = Color3.fromRGB(87, 37, 100),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(28, 15, 31), Color3.fromRGB(62, 47, 66)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(105, 46, 120),
		Tab = Color3.fromRGB(141, 66, 160),
		Element = Color3.fromRGB(123, 56, 140),
		ElementBorder = Color3.fromRGB(62, 28, 70),
		InElementBorder = Color3.fromRGB(90, 47, 100),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(151, 75, 170),
		ToggleToggled = Color3.fromRGB(55, 8, 67),
		SliderRail = Color3.fromRGB(151, 75, 170),
		DropdownFrame = Color3.fromRGB(161, 86, 180),
		DropdownHolder = Color3.fromRGB(53, 23, 60),
		DropdownBorder = Color3.fromRGB(62, 28, 70),
		DropdownOption = Color3.fromRGB(151, 75, 170),
		Keybind = Color3.fromRGB(151, 75, 170),
		Input = Color3.fromRGB(151, 75, 170),
		InputFocused = Color3.fromRGB(31, 14, 35),
		InputIndicator = Color3.fromRGB(171, 95, 190),
		InputIndicatorFocus = Color3.fromRGB(204, 0, 255),
		Dialog = Color3.fromRGB(53, 23, 60),
		DialogHolder = Color3.fromRGB(48, 18, 55),
		DialogHolderLine = Color3.fromRGB(43, 13, 50),
		DialogButton = Color3.fromRGB(53, 23, 60),
		DialogButtonBorder = Color3.fromRGB(96, 42, 110),
		DialogBorder = Color3.fromRGB(87, 37, 100),
		DialogInput = Color3.fromRGB(63, 33, 70),
		DialogInputLine = Color3.fromRGB(161, 86, 180),
		Text = Color3.fromRGB(240, 240, 240),
		SubText = Color3.fromRGB(170, 170, 170),
		Hover = Color3.fromRGB(151, 75, 170),
		HoverChange = 0.05
	},
	Forest = {
		Name = "Forest",
		Accent = Color3.fromRGB(90, 196, 120),
		AcrylicMain = Color3.fromRGB(24, 39, 29),
		AcrylicBorder = Color3.fromRGB(51, 98, 67),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(19, 30, 23), Color3.fromRGB(52, 65, 56)),
		AcrylicNoise = 0.92,
		TitleBarLine = Color3.fromRGB(63, 118, 81),
		Tab = Color3.fromRGB(86, 157, 110),
		Element = Color3.fromRGB(74, 137, 95),
		ElementBorder = Color3.fromRGB(37, 69, 48),
		InElementBorder = Color3.fromRGB(59, 98, 72),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(96, 167, 120),
		ToggleToggled = Color3.fromRGB(22, 66, 36),
		SliderRail = Color3.fromRGB(96, 167, 120),
		DropdownFrame = Color3.fromRGB(106, 176, 129),
		DropdownHolder = Color3.fromRGB(31, 59, 41),
		DropdownBorder = Color3.fromRGB(37, 69, 48),
		DropdownOption = Color3.fromRGB(96, 167, 120),
		Keybind = Color3.fromRGB(96, 167, 120),
		Input = Color3.fromRGB(96, 167, 120),
		InputFocused = Color3.fromRGB(19, 34, 24),
		InputIndicator = Color3.fromRGB(116, 186, 139),
		InputIndicatorFocus = Color3.fromRGB(50, 250, 117),
		Dialog = Color3.fromRGB(31, 59, 41),
		DialogHolder = Color3.fromRGB(26, 54, 36),
		DialogHolderLine = Color3.fromRGB(22, 49, 31),
		DialogButton = Color3.fromRGB(31, 59, 41),
		DialogButtonBorder = Color3.fromRGB(57, 108, 74),
		DialogBorder = Color3.fromRGB(51, 98, 67),
		DialogInput = Color3.fromRGB(41, 69, 50),
		DialogInputLine = Color3.fromRGB(106, 176, 129),
		Text = Color3.fromRGB(240, 240, 240),
		SubText = Color3.fromRGB(170, 170, 170),
		Hover = Color3.fromRGB(96, 167, 120),
		HoverChange = 0.05
	},
	HighContrast = {
		Name = "HighContrast",
		...
		InputIndicatorFocus = Color3.fromRGB(255, 209, 0),
...
local Library = {
	Version = "2.1.0", -- Rework Pass 2: +14 elements, +7 themes, +21 utils, tooltip/disabled/watermark/export-import/reset ฯลฯ
...
-- ============================================================
-- 🧰 Library.Utils — ฟังก์ชันช่วยเหลือทั่วไป (Rework Pass 2)
-- รวมของที่มีคนต้อง copy-paste เขียนเองบ่อยๆ (debounce, format ตัวเลข ฯลฯ)
-- ไว้ที่เดียว ใช้ซ้ำได้ทั้งใน element ของ library เองและใน script ที่เอา
-- library นี้ไปใช้ต่อ
-- ============================================================
Library.Utils = {}

-- ป้องกันฟังก์ชันถูกยิงรัวๆ ภายในเวลาที่กำหนด (เอาไว้ห่อ callback ปุ่มกันสแปมคลิก)
function Library.Utils.Debounce(Func, Wait)
	Wait = Wait or 0.25
	local waiting = false
	return function(...)
		...
		task.delay(Wait, function() waiting = false end)
	end
end

-- จำกัดให้ฟังก์ชันทำงานได้ไม่เกิน 1 ครั้งต่อช่วงเวลาที่กำหนด (ใช้กับ event ที่ยิงถี่ เช่น InputChanged)
function Library.Utils.Throttle(Func, Interval)
...
-- คัดลอกตารางแบบลึก (deep copy) กันปัญหาแก้ config ต้นฉบับโดยไม่ตั้งใจ
function Library.Utils.DeepCopy(Tbl)
	if type(Tbl) ~= "table" then return Tbl end
	local copy = {}
	for k, v in next, Tbl do
		copy[Library.Utils.DeepCopy(k)] = Library.Utils.DeepCopy(v)
	end
	return copy
end

-- ผสานตาราง default เข้ากับตารางที่ผู้ใช้ส่งมา (shallow merge, key ที่ผู้ใช้ระบุจะทับ default)
function Library.Utils.Merge(Defaults, Overrides)
	local out = {}
	for k, v in next, (Defaults or {}) do out[k] = v end
	for k, v in next, (Overrides or {}) do out[k] = v end
	return out
end

-- Linear interpolation ระหว่างตัวเลขสองค่า
function Library.Utils.Lerp(A, B, T)
	return A + (B - A) * T
end

-- Linear interpolation ระหว่างสี
function Library.Utils.LerpColor(ColorA, ColorB, T)
	return Color3.new(
...
function Library.Utils.Clamp01(X)
	return math.clamp(X, 0, 1)
end

-- แปลงค่าจากช่วงหนึ่งไปอีกช่วงหนึ่ง (เช่น map FPS 0-240 ไปเป็น progress bar 0-100)
function Library.Utils.MapRange(X, InMin, InMax, OutMin, OutMax)
	if InMax == InMin then return OutMin end
	local t = (X - InMin) / (InMax - InMin)
	return OutMin + (OutMax - OutMin) * t
end

-- ใส่ comma คั่นหลักพันให้ตัวเลข เช่น 1234567 -> "1,234,567"
function Library.Utils.FormatNumber(N)
...
-- ย่อเลขจำนวนมากๆ ให้อ่านง่าย เช่น 1500 -> "1.5K", 2400000 -> "2.4M"
function Library.Utils.FormatCompact(N)
	local absN = math.abs(N)
	local sign = N < 0 and "-" or ""
	if absN >= 1e9 then return sign .. string.format("%.1fB", absN / 1e9)
	elseif absN >= 1e6 then return sign .. string.format("%.1fM", absN / 1e6)
	elseif absN >= 1e3 then return sign .. string.format("%.1fK", absN / 1e3)
	end
	return sign .. tostring(math.floor(absN))
end

-- แปลงวินาทีเป็น mm:ss หรือ hh:mm:ss
function Library.Utils.FormatTime(Seconds)
...
-- สร้าง id สุ่มสั้นๆ ไว้ใช้เป็น key ภายในเวลาที่ไม่อยากตั้งชื่อ Idx เอง
function Library.Utils.GenerateId()
	return string.format("%x-%x-%x", os.clock() * 1000, math.random(0, 0xFFFFFF), math.random(0, 0xFFFFFF))
end

-- ค้นหาว่าค่านี้อยู่ใน array หรือไม่ (เทียบเท่า table.find แต่รองรับกรณี array มี gap)
function Library.Utils.Contains(Tbl, Value)
...
-- หา element แรกที่ผ่านเงื่อนไข predicate
function Library.Utils.Find(Tbl, Predicate)
...
-- ตัดช่องว่างหน้า-หลัง string ออก
function Library.Utils.Trim(Str)
	return (Str:gsub("^%s+", ""):gsub("%s+$", ""))
end

-- แยก string ตาม separator ที่กำหนด คืนเป็น array
function Library.Utils.Split(Str, Sep)
	Sep = Sep or "%s"
	local out = {}
...
-- คืนฟังก์ชัน canFire() ที่จะ return true ได้แค่ครั้งเดียวต่อช่วงเวลา cooldown ที่กำหนด
-- เอาไว้ห่อปุ่มกันผู้ใช้กดรัวๆ สแปม callback (ต่างจาก Debounce ตรงที่ตัวนี้คืนค่า bool ให้เช็คเองได้)
function Library.Utils.Cooldown(Seconds)
...
-- ครอบ TextService:GetTextSize พร้อม cache กันคำนวณข้อความเดิมซ้ำๆ ทุกเฟรม (ประหยัด perf)
local _textSizeCache = {}
function Library.Utils.GetTextSize(Text, Size, Font, Bounds)
	Bounds = Bounds or Vector2.new(1000, 1000)
	local key = Text .. "|" .. tostring(Size) .. "|" .. tostring(Font) .. "|" .. tostring(Bounds)
	local cached = _textSizeCache[key]
	if cached then return cached end
	local ok, result = pcall(function()
		return TextService:GetTextSize(Text, Size, Font, Bounds)
	end)
	if ok then
		_textSizeCache[key] = result
		-- กันแคชบวมไม่จำกัด ล้างทิ้งเมื่อเกิน 500 รายการ
		local count = 0
		for _ in next, _textSizeCache do count = count + 1 end
		if count > 500 then table.clear(_textSizeCache) end
		return result
	end
	return Vector2.new(0, 0)
end

-- true ถ้ากำลังรันบนอุปกรณ์มือถือ/แตะหน้าจอ (เข้าถึงง่ายกว่าต้องรับ Mobile จาก return ตัวที่ 4 ของไฟล์)
function Library.Utils.IsMobile()
	return UserInputService.TouchEnabled and not UserInputService.KeyboardEnabled
end

-- คืนสีสุ่ม เอาไว้ใช้ตอน demo/debug ธีมหรือแต่งของเล่น
function Library.Utils.RandomColor()
	return Color3.fromRGB(math.random(0, 255), math.random(0, 255), math.random(0, 255))
end

-- บีบตำแหน่ง (เช่นตำแหน่งลาก GUI) ให้อยู่ในขอบเขตจอเสมอ กัน GUI ลากหลุดจอ
function Library.Utils.ClampToScreen(Position, Size, ScreenSize)
	local x = math.clamp(Position.X, 0, math.max(0, ScreenSize.X - Size.X))
	local y = math.clamp(Position.Y, 0, math.max(0, ScreenSize.Y - Size.Y))
...
Components.Element = (function()
	...
	-- ============================================================
	-- 💬 Tooltip กลาง (Rework Pass 2) — element ไหนก็ใช้ได้แค่ใส่ Options.Tooltip
	-- ใช้ frame ใบเดียวใช้ร่วมกันทุก element กัน spawn ซ้ำเปลืองความจำ
	-- ============================================================
	local SharedTooltip = New("Frame", {
		Name = "SharedTooltip",
		...
		New("UIStroke", { Transparency = 0.4, ApplyStrokeMode = Enum.ApplyStrokeMode.Border, ThemeTag = { Color = "DialogBorder" } }),
		New("UIPadding", { PaddingLeft = UDim.new(0, 8), PaddingRight = UDim.new(0, 8), PaddingTop = UDim.new(0, 4), PaddingBottom = UDim.new(0, 4) }),
	})
	local SharedTooltipLabel = New("TextLabel", {
		Text = "",
	...
	Creator.AddSignal(RunService.Heartbeat, function()
		if SharedTooltip.Visible then
			local mousePos = UserInputService:GetMouseLocation()
			SharedTooltip.Position = UDim2.fromOffset(mousePos.X + 14, mousePos.Y + 18)
		end
	end)
	...
	return function(Title, Desc, Parent, Hover, Options)
		...
		-- 💬 Tooltip (Rework Pass 2): ใส่ Options.Tooltip = "ข้อความ" ให้ element ไหนก็ได้ ไม่ต้องแก้อะไรเพิ่ม
		...
		-- 🚫 Disabled state (Rework Pass 2): หรี่ element และบล็อกคลิกที่ Frame หลัก
		-- (element ที่มีปุ่มย่อยของตัวเอง เช่น NumberInput +/-, Colorpicker swatch อาจต้องเช็ค
		-- self.Disabled เองเพิ่มถ้าอยากบล็อกปุ่มย่อยด้วย — ตรงนี้ครอบคลุม element ปกติทั่วไปให้แล้ว)
		function Element:SetDisabled(Bool)
			Element.Disabled = Bool
			Element.Frame.Active = not Bool
			local goalTransparency = Bool and 0.6 or (Creator.GetThemeProperty("ElementTransparency") or 0.89)
			TweenService:Create(Element.TitleLabel, TweenInfo.new(0.15), { TextTransparency = Bool and 0.5 or 0 }):Play()
			TweenService:Create(Element.DescLabel, TweenInfo.new(0.15), { TextTransparency = Bool and 0.6 or 0 }):Play()
		end
...
Components.Notification = (function()
	...
	function Notification:New(Config)
		...
		-- 🔊 Rework Pass 2: เสียงแจ้งเตือน (ปิดอยู่โดย default กันคนตกใจ เปิดได้จาก Interface settings)
		if Library.NotificationSoundEnabled then
			pcall(function()
...
-- (เดิมมี Icons table ประกาศซ้ำ 828 icon ทั้งชุดตรงนี้ ซึ่งถูก shadow โดย local Icons ตัวที่สองด้านล่างทันที ทำให้ตารางนี้เป็น dead code ที่ไม่มีใครอ้างถึงเลย — ลบออกเพื่อลดขนาดไฟล์ ~830 บรรทัดและลดเวลาสร้างตารางตอนโหลดสคริปต์)
...
-- ============================================================
-- 🧩 REWORK PASS 2 — NEW / FIXED ELEMENTS
-- TagInput, SearchBar, NotifBadge เดิมมี parser ใน SaveManager
-- อยู่แล้วแต่ไม่เคยมี element จริงให้ใช้ (dead reference) — เพิ่มให้ครบ
-- ตามด้วย element ใหม่ทั้งหมด 11 ตัวที่ห้องสมุดยังไม่เคยมี
-- ============================================================
...
ElementsTable.TagInput = (function()
	...
	function Element:New(Idx, Config)
		...
		Config.MaxTags = Config.MaxTags or math.huge
		...
		TI.SetTitle = TIFrame.SetTitle
		TI.SetDesc  = TIFrame.SetDesc
		TI.Visible  = TIFrame.Visible
		TI.Elements = TIFrame
		...
		local TextInput = New("TextBox", {
			...
			TextSize = GetStyleProperty("TextSizeSm"),
			TextXAlignment = Enum.TextXAlignment.Left,
			PlaceholderText = Config.Placeholder or "Type and press Enter...",
			ClearTextOnFocus = false,
			Text = "",
			Parent = InputHolder,
		...
		local function rebuildTags()
			for _, child in ipairs(TagRow:GetChildren()) do
				if child:IsA("Frame") and child.Name == "TagPill" then
					child:Destroy()
				end
			end
			for i, tag in ipairs(TI.Value) do
				local pill = New("Frame", {
					Name = "TagPill",
					...
					New("UIPadding", { PaddingLeft = UDim.new(0, 10), PaddingRight = UDim.new(0, 6) }),
					New("TextLabel", {
						Text = tostring(tag),
						FontFace = GetStyleProperty("FontMedium"),
						TextSize = GetStyleProperty("TextSizeXs"),
				...
				Creator.AddSignal(remove.MouseButton1Click, function()
		...
		local function addTag()
			local text = TextInput.Text:gsub("^%s+", ""):gsub("%s+$", "")
			if text ~= "" and #TI.Value < Config.MaxTags and not table.find(TI.Value, text) then
		...
		Creator.AddSignal(AddBtn.MouseButton1Click, addTag)
		Creator.AddSignal(TextInput.FocusLost, function(enterPressed)
			if enterPressed then addTag() end
		end)
		...
		if Config.Default then TI:SetValue(Config.Default) end
...
ElementsTable.SearchBar = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "SearchBar"

	function Element:New(Idx, Config)
		Config = Config or {}
		assert(Config.Title, "SearchBar - Missing Title")
		...
		local SBFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		SB.SetTitle = SBFrame.SetTitle
		SB.SetDesc  = SBFrame.SetDesc
		SB.Visible  = SBFrame.Visible
		SB.Elements = SBFrame
		...
		local iconId
		pcall(function() iconId = Library:GetIcon("search") end)
		...
		IconImg.Parent = Holder

		local boxOffsetX = iconId and 30 or 10
		local Box = New("TextBox", {
			Size = UDim2.new(1, -(boxOffsetX + 36), 1, 0),
			Position = UDim2.fromOffset(boxOffsetX, 0),
			BackgroundTransparency = 1,
			FontFace = GetStyleProperty("FontMedium"),
			TextSize = GetStyleProperty("TextSizeSm"),
			TextXAlignment = Enum.TextXAlignment.Left,
		...
		local function set(v, fireCallback)
			...
			if fireCallback ~= false then
				Library:SafeCallback(SB.Callback, v)
				Library:SafeCallback(SB.Changed, v)
			end
		end
		...
		function SB:OnChanged(Func) SB.Changed = Func Func(SB.Value) end
		function SB:SetValue(v) set(v or "", true) end
		function SB:Destroy() SBFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		if Idx then Library.Options[Idx] = SB end
		return SB
	end
...
ElementsTable.NotifBadge = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "NotifBadge"

	function Element:New(Idx, Config)
		Config = Config or {}
		assert(Config.Title, "NotifBadge - Missing Title")
		Config.Max = Config.Max or 99

		local NB = {
			Type = "NotifBadge",
			Count = Config.Default or 0,
		}

		local NBFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		NB.SetTitle = NBFrame.SetTitle
		NB.SetDesc  = NBFrame.SetDesc
		NB.Visible  = NBFrame.Visible
		NB.Elements = NBFrame
		...
		function NB:SetCount(n)
			n = math.max(0, math.floor(tonumber(n) or 0))
			NB.Count = n
			CountLabel.Text = n > Config.Max and (tostring(Config.Max) .. "+") or tostring(n)
			Badge.Visible = n > 0 or Config.ShowZero == true
		end
		function NB:Destroy() NBFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		NB:SetCount(NB.Count)

		if Idx then Library.Options[Idx] = NB end
		return NB
	end
...
ElementsTable.ProgressBar = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "ProgressBar"

	function Element:New(Idx, Config)
		Config = Config or {}
		assert(Config.Title, "ProgressBar - Missing Title")
		Config.Min = Config.Min or 0
		Config.Max = Config.Max or 100
		...
		PB.Value = Config.Default or Config.Min

		local PBFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		PB.SetTitle = PBFrame.SetTitle
		PB.SetDesc  = PBFrame.SetDesc
		PB.Visible  = PBFrame.Visible
		PB.Elements = PBFrame
		...
		local PercentLabel = New("TextLabel", {
			...
			TextSize = GetStyleProperty("TextSizeXs"),
			TextColor3 = Color3.fromRGB(255, 255, 255),
			Visible = Config.ShowPercent,
			ZIndex = 2,
			Parent = Track,
		})

		function PB:SetValue(v, instant)
			v = math.clamp(v, PB.Min, PB.Max)
			PB.Value = v
			local pct = (PB.Max > PB.Min) and (v - PB.Min) / (PB.Max - PB.Min) or 0
			if instant then
				Fill.Size = UDim2.new(pct, 0, 1, 0)
			else
				TweenService:Create(Fill, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Size = UDim2.new(pct, 0, 1, 0) }):Play()
			end
			PercentLabel.Text = string.format("%d%%", math.floor(pct * 100 + 0.5))
		end
		function PB:Destroy() PBFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		PB:SetValue(PB.Value, true)

		if Idx then Library.Options[Idx] = PB end
		return PB
	end
...
ElementsTable.Rating = (function()
	...
	function Element:New(Idx, Config)
		...
		R.SetTitle = RFrame.SetTitle
		R.SetDesc  = RFrame.SetDesc
		R.Visible  = RFrame.Visible
		R.Elements = RFrame

		local starIcon = ""
		pcall(function() starIcon = Library:GetIcon("star") or "" end)

		local Row = New("Frame", {
			Size = UDim2.fromOffset(Config.Max * 20, 18),
			Position = UDim2.new(1, -10, 0.5, 0),
			AnchorPoint = Vector2.new(1, 0.5),
			BackgroundTransparency = 1,
			Parent = RFrame.Frame,
		...
		for i = 1, Config.Max do
			...
			Creator.AddThemeObject(star, { ImageColor3 = (i <= R.Value) and "Accent" or "SubText" })
			Stars[i] = star
		end

		local function refresh(hoverCount)
			local n = hoverCount or R.Value
			for i, star in ipairs(Stars) do
				Creator.OverrideTag(star, { ImageColor3 = (i <= n) and "Accent" or "SubText" })
			end
		end

		for i, star in ipairs(Stars) do
			Creator.AddSignal(star.MouseEnter, function() refresh(i) end)
			Creator.AddSignal(star.MouseLeave, function() refresh() end)
			Creator.AddSignal(star.MouseButton1Click, function()
				R.Value = (R.Value == i) and 0 or i
				refresh()
				Library:SafeCallback(R.Callback, R.Value)
				Library:SafeCallback(R.Changed, R.Value)
			end)
		end

		function R:OnChanged(Func) R.Changed = Func Func(R.Value) end
		function R:SetValue(v)
			R.Value = math.clamp(v or 0, 0, Config.Max)
			refresh()
		end
		function R:Destroy() RFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		if Idx then Library.Options[Idx] = R end
		return R
	end
...
ElementsTable.SegmentedControl = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "SegmentedControl"

	function Element:New(Idx, Config)
		Config = Config or {}
		assert(Config.Title, "SegmentedControl - Missing Title")
		assert(Config.Options and #Config.Options > 0, "SegmentedControl - Missing Options")
		...
		local SCFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		SC.SetTitle = SCFrame.SetTitle
		SC.SetDesc  = SCFrame.SetDesc
		SC.Visible  = SCFrame.Visible
		SC.Elements = SCFrame

		local optionCount = #Config.Options
		local segWidth = 60
		local Track = New("Frame", {
			Size = UDim2.fromOffset(segWidth * optionCount, 26),
			Position = UDim2.new(1, -10, 0.5, 0),
			AnchorPoint = Vector2.new(1, 0.5),
			BackgroundTransparency = 0.75,
			Parent = SCFrame.Frame,
			ThemeTag = { BackgroundColor3 = "Element" },
		}, {
			NewCorner("PillCorner"),
			New("UISizeConstraint", { MaxSize = Vector2.new(segWidth * optionCount, math.huge) }),
		})

		local Highlight = New("Frame", {
			Size = UDim2.new(1 / optionCount, -4, 1, -4),
		...
		for i, option in ipairs(Config.Options) do
			local btn = New("TextButton", {
				...
				Position = UDim2.new((i - 1) / optionCount, 0, 0, 0),
				BackgroundTransparency = 1,
				ZIndex = 2,
				Parent = Track,
				ThemeTag = { TextColor3 = "Text" },
			})
			Buttons[option] = { Button = btn, Index = i }
			Creator.AddSignal(btn.MouseButton1Click, function()
				SC:SetValue(option)
			end)
		end

		function SC:SetValue(v)
			local entry = Buttons[v]
			if not entry then return end
			SC.Value = v
			TweenService:Create(Highlight, TweenInfo.new(0.22, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
				Position = UDim2.new((entry.Index - 1) / optionCount, 2, 0, 2),
			}):Play()
			Library:SafeCallback(SC.Callback, v)
			Library:SafeCallback(SC.Changed, v)
		end
		function SC:OnChanged(Func) SC.Changed = Func Func(SC.Value) end
		function SC:Destroy() SCFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		local initEntry = Buttons[SC.Value]
		if initEntry then
			Highlight.Position = UDim2.new((initEntry.Index - 1) / optionCount, 2, 0, 2)
		end

		if Idx then Library.Options[Idx] = SC end
		return SC
	end
...
ElementsTable.RangeSlider = (function()
	...
	function Element:New(Idx, Config)
		...
		assert(Config.Min ~= nil, "RangeSlider - Missing minimum value.")
		assert(Config.Max ~= nil, "RangeSlider - Missing maximum value.")
		Config.Rounding = Config.Rounding or 0
		Config.Default = Config.Default or { Config.Min, Config.Max }

		local RS = {
			Type = "RangeSlider",
			Min = Config.Min,
			Max = Config.Max,
			Value = { Config.Default[1], Config.Default[2] },
			Callback = Config.Callback or function() end,
		}

		local RSFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		RSFrame.DescLabel.Size = UDim2.new(1, -170, 0, 14)
		RS.SetTitle = RSFrame.SetTitle
		RS.SetDesc  = RSFrame.SetDesc
		RS.Visible  = RSFrame.Visible
		RS.Elements = RSFrame
		...
		local RailHolder = New("Frame", {
			Size = UDim2.new(1, 0, 0, 6),
			AnchorPoint = Vector2.new(1, 0.5),
			Position = UDim2.new(1, -10, 0.5, 10),
			BackgroundTransparency = 0.45,
			Parent = RSFrame.Frame,
			ThemeTag = { BackgroundColor3 = "SliderRail" },
		}, {
			NewCorner("PillCorner"),
			New("UISizeConstraint", { MaxSize = Vector2.new(150, math.huge) }),
		...
		local Fill = New("Frame", {
			...
			NewCorner("PillCorner"),
			New("UIGradient", { ThemeTag = { Color = "AccentGradient" } }),
		})
		...
		local function makeDot()
			return New("Frame", {
				...
				NewCorner("PillCorner"),
				New("UIAspectRatioConstraint", { AspectRatio = 1 }),
				New("UIStroke", { Thickness = 1.75, ApplyStrokeMode = Enum.ApplyStrokeMode.Border, ThemeTag = { Color = "Accent" } }),
			})
		end

		local MinDot, MaxDot = makeDot(), makeDot()
		local DraggingHandle = nil

		local function refresh()
			local span = (RS.Max - RS.Min)
			local a = span ~= 0 and math.clamp((RS.Value[1] - RS.Min) / span, 0, 1) or 0
			local b = span ~= 0 and math.clamp((RS.Value[2] - RS.Min) / span, 0, 1) or 0
			MinDot.Position = UDim2.new(a, 0, 0.5, 0)
			MaxDot.Position = UDim2.new(b, 0, 0.5, 0)
			Fill.Position = UDim2.new(a, 0, 0, 0)
			Fill.Size = UDim2.new(b - a, 0, 1, 0)
			RangeDisplay.Text = tostring(RS.Value[1]) .. " - " .. tostring(RS.Value[2])
		end

		function RS:SetValue(a, b)
			a = Library:Round(math.clamp(a, RS.Min, RS.Max), Config.Rounding)
			b = Library:Round(math.clamp(b, RS.Min, RS.Max), Config.Rounding)
			if a > b then a, b = b, a end
			RS.Value = { a, b }
			refresh()
			Library:SafeCallback(RS.Callback, RS.Value)
			Library:SafeCallback(RS.Changed, RS.Value)
		end
		function RS:OnChanged(Func) RS.Changed = Func Func(RS.Value) end
		function RS:Destroy() RSFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end
		...
		Creator.AddSignal(MinDot.InputBegan, beginDrag("min"))
		Creator.AddSignal(MaxDot.InputBegan, beginDrag("max"))
		Creator.AddSignal(MinDot.InputEnded, endDrag)
		Creator.AddSignal(MaxDot.InputEnded, endDrag)
		...
		Creator.AddSignal(UserInputService.InputChanged, function(Input)
			...
			local scale = math.clamp((pos.X - Rail.AbsolutePosition.X) / Rail.AbsoluteSize.X, 0, 1)
			local value = RS.Min + (RS.Max - RS.Min) * scale
			if DraggingHandle == "min" then
				RS:SetValue(value, RS.Value[2])
			else
				RS:SetValue(RS.Value[1], value)
			end
		end)
...
ElementsTable.Timeline = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "Timeline"

	function Element:New(Idx, Config)
		Config = Config or {}
		assert(Config.Title, "Timeline - Missing Title")
		Config.Steps = Config.Steps or {}

		local TL = { Type = "Timeline" }

		local TLFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		TL.SetTitle = TLFrame.SetTitle
		TL.SetDesc  = TLFrame.SetDesc
		TL.Visible  = TLFrame.Visible
		TL.Elements = TLFrame
		...
		function TL:SetSteps(steps)
			for _, c in ipairs(List:GetChildren()) do
				if c:IsA("Frame") and c.Name == "TLRow" then c:Destroy() end
			end
			for i, step in ipairs(steps) do
				local isLast = (i == #steps)
				local done = step.Done == true
				...
				local IconCol = New("Frame", {
					...
					New("Frame", {
						...
						BackgroundTransparency = done and 0 or 0.6,
						ThemeTag = { BackgroundColor3 = done and "Accent" or "SubText" },
					}, { NewCorner("PillCorner") }),
				})
				if not isLast then
					New("Frame", {
		...
		function TL:Destroy() TLFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		TL:SetSteps(Config.Steps)

		if Idx then Library.Options[Idx] = TL end
		return TL
	end
...
ElementsTable.Breadcrumb = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "Breadcrumb"

	function Element:New(Idx, Config)
		Config = Config or {}
		assert(Config.Title, "Breadcrumb - Missing Title")
		Config.Path = Config.Path or {}
		Config.Separator = Config.Separator or ">"

		local BC = { Type = "Breadcrumb", Callback = Config.Callback or function() end }

		local BCFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		BC.SetTitle = BCFrame.SetTitle
		BC.SetDesc  = BCFrame.SetDesc
		BC.Visible  = BCFrame.Visible
		BC.Elements = BCFrame
		...
		local Row = New("Frame", {
			...
			New("UIPadding", { PaddingBottom = UDim.new(0, 6) }),
		})

		function BC:SetPath(path)
			for _, c in ipairs(Row:GetChildren()) do
				if c:IsA("TextButton") or (c:IsA("TextLabel") and c.Name == "Sep") then c:Destroy() end
			end
			for i, crumb in ipairs(path) do
				local isLast = (i == #path)
				local label = New("TextButton", {
					Text = tostring(crumb),
					FontFace = GetStyleProperty(isLast and "FontBold" or "FontMedium"),
					TextSize = GetStyleProperty("TextSizeSm"),
					AutomaticSize = Enum.AutomaticSize.X,
					Size = UDim2.fromOffset(0, 18),
					BackgroundTransparency = 1,
				...
				if not isLast then
					Creator.AddSignal(label.MouseButton1Click, function()
						Library:SafeCallback(BC.Callback, crumb, i)
					end)
					New("TextLabel", {
						Name = "Sep",
		...
		function BC:Destroy() BCFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		BC:SetPath(Config.Path)

		if Idx then Library.Options[Idx] = BC end
		return BC
	end
...
ElementsTable.EmptyState = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "EmptyState"
	Element.NoIdx = true

	function Element:New(Config)
		Config = Config or {}
		Config.Title = Config.Title or "Nothing here yet"
		Config.Icon = Config.Icon or "inbox"

		local ES = { Type = "EmptyState" }
		...
		local iconId
		pcall(function() iconId = Library:GetIcon(Config.Icon) end)
		if iconId then
			New("ImageLabel", {
				Image = iconId,
				Size = UDim2.fromOffset(30, 30),
		...
		function ES:Destroy() Root:Destroy() end
		function ES:SetVisible(bool) Root.Visible = bool end
...
ElementsTable.LoadingSpinner = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "LoadingSpinner"

	function Element:New(Idx, Config)
		Config = Config or {}
		assert(Config.Title, "LoadingSpinner - Missing Title")

		local LS = { Type = "LoadingSpinner", Spinning = Config.Default ~= false }

		local LSFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		LS.SetTitle = LSFrame.SetTitle
		LS.SetDesc  = LSFrame.SetDesc
		LS.Visible  = LSFrame.Visible
		LS.Elements = LSFrame

		local loaderIcon = ""
		pcall(function() loaderIcon = Library:GetIcon("loader-2") or "" end)
		...
		local Spinner = New("ImageLabel", {
			...
			AnchorPoint = Vector2.new(1, 0.5),
			BackgroundTransparency = 1,
			Parent = LSFrame.Frame,
			ThemeTag = { ImageColor3 = "Accent" },
		})

		local spinConnection
		function LS:SetSpinning(bool)
			LS.Spinning = bool
		...
		function LS:Destroy()
			...
			LSFrame.Frame:Destroy()
			if Idx then Library.Options[Idx] = nil end
		end

		LS:SetSpinning(LS.Spinning)

		if Idx then Library.Options[Idx] = LS end
		return LS
	end
...
ElementsTable.CodeBlock = (function()
	...
	function Element:New(Idx, Config)
		Config = Config or {}
		assert(Config.Title, "CodeBlock - Missing Title")
		Config.Code = Config.Code or ""
		...
		local monoFont = GetStyleProperty("FontMedium")
		pcall(function()
			local f = Font.new("rbxasset://fonts/families/RobotoMono.json")
			if f then monoFont = f end
		end)
		...
		local copyIcon
		pcall(function() copyIcon = Library:GetIcon("copy") end)
		if copyIcon then
			New("ImageLabel", {
				Image = copyIcon,
				Size = UDim2.fromOffset(12, 12),
		...
		Creator.AddSignal(CopyBtn.MouseButton1Click, function()
			local copied = false
			pcall(function()
				if setclipboard then setclipboard(CB.Code) copied = true end
			end)
			Library:Notify({ Title = "Interface", Content = copied and "Code copied to clipboard." or "Clipboard not supported here.", Type = copied and "success" or "warning", Duration = 3 })
		end)
...
ElementsTable.HotkeyDisplay = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "HotkeyDisplay"

	function Element:New(Idx, Config)
		Config = Config or {}
		assert(Config.Title, "HotkeyDisplay - Missing Title")
		Config.Keys = Config.Keys or { "?" }

		local HD = { Type = "HotkeyDisplay" }

		local HDFrame = Components.Element(Config.Title, Config.Description, self.Container, false, Config)
		HD.SetTitle = HDFrame.SetTitle
		HD.SetDesc  = HDFrame.SetDesc
		HD.Visible  = HDFrame.Visible
		HD.Elements = HDFrame
		...
		function HD:SetKeys(keys)
			...
			for i, key in ipairs(keys) do
				New("Frame", {
					...
					NewCorner("TinyCorner"),
					New("UIStroke", { Thickness = 1, Transparency = 0.4, ApplyStrokeMode = Enum.ApplyStrokeMode.Border, ThemeTag = { Color = "ElementBorder" } }),
					New("UIPadding", { PaddingLeft = UDim.new(0, 8), PaddingRight = UDim.new(0, 8) }),
					New("TextLabel", {
						Text = tostring(key),
						FontFace = GetStyleProperty("FontBold"),
		...
		function HD:Destroy() HDFrame.Frame:Destroy() if Idx then Library.Options[Idx] = nil end end

		HD:SetKeys(Config.Keys)

		if Idx then Library.Options[Idx] = HD end
		return HD
	end
...
ElementsTable.StatCard = (function()
	local Element = {}
	Element.__index = Element
	Element.__type = "StatCard"
	Element.NoIdx = true

	function Element:New(Config)
		Config = Config or {}
		assert(Config.Title, "StatCard - Missing Title")
		Config.Value = Config.Value or "0"

		local SC = { Type = "StatCard" }
		...
		local Root = New("Frame", {
			...
			NewCorner("ElementCorner"),
			New("UIStroke", { Transparency = 0.5, ApplyStrokeMode = Enum.ApplyStrokeMode.Border, ThemeTag = { Color = "ElementBorder" } }),
		...
		function SC:SetValue(v) SC.Value = v; ValueLabel.Text = tostring(v) end
		function SC:Destroy() Root:Destroy() end
...
-- ============================================================
-- END OF REWORK PASS 2 NEW ELEMENTS
-- ============================================================

-- (เดิมตรงนี้มี "local NotificationModule = Components.Notification" + "NotificationModule:Init(GUI)"
-- + "local New = Creator.New" ซ้ำกับก่อนหน้า Accordion อีกชุดหนึ่ง — เป็นการ Init notification holder ซ้ำสอง
-- รอบโดยไม่จำเป็น (สร้าง Frame ว่างทิ้งไว้เฉยๆ) ลบชุดที่ซ้ำออก เหลือไว้ชุดเดียวก่อน Accordion)
...
for _, ElementComponent in pairs(ElementsTable) do
	Elements["Add" .. ElementComponent.__type] = function(self, Idx, Config)
		...
		if ElementComponent.NoIdx then
			instance = ElementComponent:New(Idx)
		else
			instance = ElementComponent:New(Idx, Config)
		end

		-- Rework Pass 2: เก็บ Config.Default ไว้ที่ตัว instance เอง (ถ้ายังไม่มี) แบบรวมศูนย์
		-- จุดเดียวตรงนี้ แทนที่จะต้องไปแก้ constructor ของ element ทีละตัว (~35 ตัว) —
		-- ทำให้ปุ่ม "Reset to default" ใน Config tab ใช้ได้กับ element ทุกตัวโดยไม่ต้อง
		-- แตะโค้ดเดิมของแต่ละ element เลย
		if type(instance) == "table" and instance.Default == nil then
			local cfgForDefault = ElementComponent.NoIdx and Idx or Config
			if type(cfgForDefault) == "table" and cfgForDefault.Default ~= nil then
				instance.Default = cfgForDefault.Default
			end
		end
...
local SaveManager = {} do
	...
	SaveManager.Parser = {
		...
		SegmentedControl = {
			Save = function(idx, object)
				return { type = "SegmentedControl", idx = idx, value = object.Value }
			end,
			Load = function(idx, data)
				if SaveManager.Options[idx] then
					SaveManager.Options[idx]:SetValue(data.value)
		...
		RangeSlider = {
			Save = function(idx, object)
				return { type = "RangeSlider", idx = idx, value = { object.Value[1], object.Value[2] } }
			end,
			Load = function(idx, data)
				if SaveManager.Options[idx] and data.value then
					SaveManager.Options[idx]:SetValue(data.value[1], data.value[2])
				end
			end,
		},
	...
	-- ============================================================
	-- 📤📥 Export / Import เป็น string (Rework Pass 2)
	-- เอาไว้แชร์ config ให้เพื่อนแบบไม่ต้องส่งไฟล์ - เข้ารหัสเป็น JSON string
	-- เดียวกับที่ Save() เขียนลงไฟล์ทุกอย่าง ต่างกันแค่ปลายทางเป็น string/clipboard
	-- ============================================================
	function SaveManager:Export()
		...
		return true, encoded, copied
	end

	function SaveManager:ImportFromString(rawString)
		if not rawString or rawString == "" then
			return false, "empty string"
		end

		local success, decoded = pcall(httpService.JSONDecode, httpService, rawString)
		...
		if Fluent then Fluent.SettingLoaded = true end
	...
	SaveManager.IgnoreThemeSettings = function(self)
		...
		self:SetIgnoreIndexes({ 
			...
			"InterfaceTheme", "TransparentToggle", "MenuKeybind", "NotificationSound"
		})
	...
	function SaveManager:BuildConfigSection(tab)
		...
		-- ── แถวที่ 4: Export / Import เป็น string (Rework Pass 2) ──────────
		-- แชร์ config ให้เพื่อนแบบ copy-paste string เดียว ไม่ต้องส่งไฟล์กัน
		section:AddButtonGroup("SaveManager_ExportImport", {
			Title = "Share config",
			Description = "Export copies the current settings as a string to your clipboard",
			Buttons = {
				{
					Text = "Export",
					Callback = function()
						local success, result, copied = self:Export()
						if not success then
							return self.Library:Notify({ Title = "Interface", Content = "Config loader", SubContent = "Export failed: " .. tostring(result), Duration = 6 })
						end
						self.Library:Notify({
							Title = "Interface",
							Content = "Config loader",
							SubContent = copied and "Config copied to clipboard!" or "Config encoded (clipboard not supported here)",
							Duration = 5,
						})
					end,
				},
				{
					Text = "Import",
					Callback = function()
						local raw = SaveManager.Options.SaveManager_ImportString and SaveManager.Options.SaveManager_ImportString.Value or ""
						if raw == "" then
							return self.Library:Notify({ Title = "Interface", Content = "Config loader", SubContent = "Paste a config string first", Duration = 5 })
						end
						local success, err = self:ImportFromString(raw)
						if not success then
							return self.Library:Notify({ Title = "Interface", Content = "Config loader", SubContent = "Import failed: " .. tostring(err), Duration = 6 })
						end
						self.Library:Notify({ Title = "Interface", Content = "Config loader", SubContent = "Config imported!", Duration = 5 })
					end,
				},
			},
		})
		section:AddInput("SaveManager_ImportString", { Title = "Import string", Description = "Paste an exported config string here, then hit Import", Default = "" })

		-- ── แถวที่ 5: Reset to default (Rework Pass 2) ─────────────────────
		section:AddButtonGroup("SaveManager_ResetDefaults", {
			Title = "Reset",
			Description = "Restores every setting registered so far to its Default value",
			Buttons = {
				{
					Text = "Reset to default",
					Callback = function()
						for idx, option in next, SaveManager.Options do
							if option.Default ~= nil and option.SetValue and not SaveManager.Ignore[idx] then
								pcall(function() option:SetValue(option.Default) end)
							end
						end
						self.Library:Notify({ Title = "Interface", Content = "Config loader", SubContent = "Settings reset to default", Duration = 5 })
					end,
				},
			},
		})

		SaveManager:SetIgnoreIndexes({ "SaveManager_ConfigList", "SaveManager_ConfigName", "SaveManager_ImportString" })
...
local InterfaceManager = {} do
	...
	InterfaceManager.Settings = {
		...
		-- Rework Pass 2: การตั้งค่าใหม่ที่ persist ผ่าน InterfaceManager
	...
	function InterfaceManager:BuildInterfaceSection(tab)
		...
		-- Rework Pass 2: Toggle เปิด/ปิดเสียงแจ้งเตือน (persist ผ่าน InterfaceManager เหมือนค่าอื่นๆ)
		Library.NotificationSoundEnabled = Settings.NotificationSound == true
		local NotifSoundToggle = section:AddToggle("NotificationSound", {
			Title = "Notification sound",
			Description = "Play a short sound when a notification appears",
			Default = Settings.NotificationSound == true,
		})
		NotifSoundToggle:OnChanged(function()
			Settings.NotificationSound = NotifSoundToggle.Value
			Library.NotificationSoundEnabled = NotifSoundToggle.Value
			InterfaceManager:SaveSettings()
		end)
...
-- ============================================================
-- 📊 Library:CreateWatermark (Rework Pass 2)
-- แถบเล็กๆ มุมบนซ้าย โชว์ FPS / ชื่อ script / ข้อความ custom ที่อัปเดตได้
-- ลากย้ายตำแหน่งได้ ปิดได้ด้วย :Destroy()
-- ============================================================
function Library:CreateWatermark(Config)
	Config = Config or {}
	Config.Text = Config.Text or "Zzen"
	Config.ShowFPS = Config.ShowFPS ~= false
	...
	local Root = New("Frame", {
		...
		NewCorner("SmallCorner"),
		New("UIStroke", { Transparency = 0.5, ApplyStrokeMode = Enum.ApplyStrokeMode.Border, ThemeTag = { Color = "AcrylicBorder" } }),
	...
	if Config.ShowFPS then
		heartbeatConn = Creator.AddSignal(RunService.Heartbeat, function()
			frames = frames + 1
			local now = os.clock()
...
-- Rework Pass 2: เปิด global ชื่อ "Zzen" คู่ไปกับ "Fluent" เดิม (เผื่อ script อื่นยัง
-- getgenv().Fluent อยู่ ก็ไม่พัง แต่ก็เรียกผ่านชื่อไฟล์ตัวเองได้ด้วย)
if getgenv then

	getgenv().Fluent = Library
	getgenv().Zzen = Library
...
Creator.AddSignal(RunService.Heartbeat, function()
	...
	if isDragging and dragStart and dragOffset and activeMin and activeMin.Parent then
		...
		-- ใช้ Library.Utils.ClampToScreen แทนโค้ด clamp มือ 4 if ด้านบน (Rework Pass 2: DRY + ใช้ utils ที่เพิ่งเพิ่ม)
		local clamped = Library.Utils.ClampToScreen(Vector2.new(newX, newY), minimizerSize, viewportSize)

		activeMin.Position = UDim2.new(0, clamped.X, 0, clamped.Y)
