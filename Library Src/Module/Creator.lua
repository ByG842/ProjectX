...
-- ✅ ฟังก์ชันเหล่านี้เดิมเป็น local upvalue ที่ใช้ร่วมกันได้ทั้งไฟล์
-- ตอนนี้แยกไฟล์แล้วต้องแปะไว้บน Creator เพื่อให้ Components/Elements/Main เรียกใช้ได้
Creator.GetStyleProperty = GetStyleProperty
Creator.ApplyStyle       = ApplyStyle
Creator.NewCorner        = NewCorner
Creator.NewStroke        = NewStroke
Creator.RegisterCorner   = RegisterCorner
Creator.RegisterStroke   = RegisterStroke
Creator.RegisterText     = RegisterText
Creator.ViewportPointToWorld = viewportPointToWorld
Creator.GetOffset        = getOffset
