...
-- ====== URL ของแต่ละโมดูล (GitHub raw) ======
local URLS = {
	Icons      = "https://raw.githubusercontent.com/ByG842/ProjectX/refs/heads/main/Library%20Src/Module/Icons.lua",
	Themes     = "https://raw.githubusercontent.com/ByG842/ProjectX/refs/heads/main/Library%20Src/Module/Themes.lua",
	Creator    = "https://raw.githubusercontent.com/ByG842/ProjectX/refs/heads/main/Library%20Src/Module/Creator.lua",
	Components = "https://raw.githubusercontent.com/ByG842/ProjectX/refs/heads/main/Library%20Src/Module/Components.lua",
	Elements   = "https://raw.githubusercontent.com/ByG842/ProjectX/refs/heads/main/Library%20Src/Module/Elements.lua",
	Managers   = "https://raw.githubusercontent.com/ByG842/ProjectX/refs/heads/main/Library%20Src/Module/Managers.lua",
}
...
local function fetch(name)
	...
	assert(ok and source and #source > 0, "โหลดไฟล์ " .. name .. " ไม่สำเร็จ: " .. tostring(source))

	local chunk, err = loadstring(source, name)
	assert(chunk, "คอมไพล์ไฟล์ " .. name .. " ไม่สำเร็จ: " .. tostring(err))

	return chunk
end

local Icons = fetch("Icons")()
local Themes, StyleThemes = fetch("Themes")()
local Creator, Library = fetch("Creator")(Themes, StyleThemes)
local Components = fetch("Components")(Creator, Library, Mobile)
local Elements, ElementsTable = fetch("Elements")(Components, Library)
