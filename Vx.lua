...
Components.Tab = (function()
	...
	function TabModule:SelectTab(Tab)
		...
		if Window.TitleBar and Window.TitleBar.CurrentTabLabel then
			Window.TitleBar.CurrentTabLabel.Text = TabModule.Tabs[Tab].Name
		end
...
Components.TitleBar = (function()
	...
	return function(Config)
		...
		-- 🏷️ [ จุดที่เพิ่ม ] Label แสดงชื่อ Tab หลักที่กำลังเปิดอยู่ ไว้ใน Header (TitleBar)
		-- แทนที่จะโชว์ในเนื้อหาแท็บ — ค่า Text จะถูกอัปเดตอัตโนมัติทุกครั้งที่สลับแท็บ
		-- ใน TabModule:SelectTab (ดูจุดที่อัปเดต Window.TabDisplay.Text)
		TitleBar.CurrentTabLabel = New("TextLabel", {
