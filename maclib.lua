...
function MacLib:Window(Settings)
	...
	-- ============================================================
	-- FU-STYLE TITLE BAR: Controls LEFT | Logo+Title+Subtitle RIGHT
	-- ============================================================
	...
	-- ── LEFT SECTION: macOS-style traffic lights ──────────────
	...
	controls.Size = UDim2.new(0, 80, 1, 0)  -- fixed width left section
	...
	local windowControlSettings = {
		sizes = { enabled = UDim2.fromOffset(12, 12), disabled = UDim2.fromOffset(11, 11) },
	...
	-- ── RIGHT SECTION: Logo + Title + Subtitle ─────────────────
	local rightInfoSection = Instance.new("Frame")
	rightInfoSection.Name = "RightInfoSection"
	rightInfoSection.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	rightInfoSection.BackgroundTransparency = 1
	rightInfoSection.BorderColor3 = Color3.fromRGB(0, 0, 0)
	rightInfoSection.BorderSizePixel = 0
	rightInfoSection.AnchorPoint = Vector2.new(1, 0)
	rightInfoSection.Position = UDim2.fromScale(1, 0)
	rightInfoSection.Size = UDim2.new(1, -80, 1, 0)

	local rightInfoLayout = Instance.new("UIListLayout")
	rightInfoLayout.Name = "RightInfoLayout"
	rightInfoLayout.Padding = UDim.new(0, 10)
	rightInfoLayout.FillDirection = Enum.FillDirection.Horizontal
	rightInfoLayout.SortOrder = Enum.SortOrder.LayoutOrder
	rightInfoLayout.VerticalAlignment = Enum.VerticalAlignment.Center
	rightInfoLayout.HorizontalAlignment = Enum.HorizontalAlignment.Right
	rightInfoLayout.Parent = rightInfoSection

	local rightInfoPadding = Instance.new("UIPadding")
	rightInfoPadding.Name = "RightInfoPadding"
	rightInfoPadding.PaddingRight = UDim.new(0, 14)
	rightInfoPadding.Parent = rightInfoSection
	...
	if Settings.Logo then
		...
		logoFrame.Parent = rightInfoSection
	end
	...
	textStack.Parent = rightInfoSection
	rightInfoSection.Parent = windowControls

	-- GlobalSettings button (globe icon) — still inside rightInfoSection as overlay
	...
	globalSettingsButton.ImageTransparency = 0.6
	globalSettingsButton.AnchorPoint = Vector2.new(0, 0.5)
	...
	globalSettingsButton.Position = UDim2.new(0, 14, 0.5, 0)
	globalSettingsButton.Size = UDim2.fromOffset(16, 16)
	globalSettingsButton.ZIndex = 3
	globalSettingsButton.Parent = windowControls
	...
	information.Position = UDim2.fromOffset(0, 52)
	...
	sidebarGroup.Position = UDim2.fromOffset(0, 52)
	sidebarGroup.Size = UDim2.new(1, 0, 1, -52)
