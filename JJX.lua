	...
	function InterfaceManager:BuildInterfaceSection(tab)
		...
		BackgroundImageInput = customBgSection:AddInput("CustomBackgroundImage", {
			...
			Description = hasUrlDownloadSupport
				and "Paste rbxassetid://, an image link (downloaded + cached), or a local file path, then press Enter. Note: Discord CDN links expire."
				or "Paste an rbxassetid:// (e.g. rbxassetid://13196113628) — this executor can't download from links directly.",
