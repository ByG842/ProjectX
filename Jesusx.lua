...
ElementsTable.Chip = (function()
	...
	function Element:New(Idx, Config)
		...
		for _, item in ipairs(Config.Items) do
			...
			-- [ จุดที่แก้ ] ย้าย pop animation มาไว้ที่ Glow ซึ่งเป็นลูกตกแต่งแยกต่างหาก
			-- ไม่แตะ Size/UIScale ของตัว chip เองเลย เพราะ UIListLayout วัดขนาดจากตัว chip ตรงๆ
			-- ถ้า chip ขยับขนาด ปุ่มข้างๆ จะไหลตามไปด้วย — Glow ที่เป็นแค่ลูกตกแต่งขยายได้อิสระไม่กระทบใคร
